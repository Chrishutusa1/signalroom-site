...
(function() {
    var linkedInUrls = {
        ...
        'Susie Branagan': 'https://www.linkedin.com/in/susie-branagan-bsn-rn-b6319339',
        ...
        'Carol Velandia': 'https://www.linkedin.com/in/carol-velandia-mba-chi-pmp-msw-599b753',
        'Keshavan Seshadri': 'https://www.linkedin.com/in/keshavan-seshadri',
        'Larry Kuhn': 'https://www.linkedin.com/in/larrykuhn/',
        'Parth Gargish': 'https://www.linkedin.com/in/parthgargish/',
        'Ritu Chakrawarty': 'https://www.linkedin.com/in/ritu-chakrawarty',
    ...
    function lookupName(raw) {
        var name = (raw || '').trim();
        return linkedInUrls[name] || linkedInUrls[name.replace(/^Dr\.\s+/, '')];
    }
